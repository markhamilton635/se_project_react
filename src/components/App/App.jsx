            ...
            <ModalWithForm title="New garmet" buttonText="Add garmet" activeModal={activeModal} isOpen={activeModal === "add-garment"} onClose={closeActiveModal}>
                ...
                <fieldset className="modal__radio-buttons">
                    ...
                    <label htmlFor="hot" className="modal__label modal__label_type_radio">
                        <input id="hot" name="1" type="radio" className="modal__radio-input" /> Hot
                    </label>
                    <label htmlFor="warm" className="modal__label modal__label_type_radio">
                        <input id="warm" name="1" type="radio" className="modal__radio-input" /> Warm
                    </label>
                    <label htmlFor="cold" className="modal__label modal__label_type_radio">
                        <input id="cold" name="1" type="radio" className="modal__radio-input" /> Cold
                    </label>
                </fieldset>
            </ModalWithForm>
